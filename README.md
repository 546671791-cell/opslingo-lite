# OpsLingo Lite / 离线英语进阶书

一个面向中文用户的离线英语学习 PWA 与 Android 应用：以日常交流、美国生活、职场和分级进阶学习为主，同时保留酒店与航旅业务训练。学习记录仅保存在当前设备的 IndexedDB。
...
- 20,000 条经过频率筛选的英汉词汇，分为 5 个可选离线包；主题页每次“换一批”都会展示下一批不同词汇
- 前 3,000 个高频词内置统一的标准美式发音，另有 IPA、字母拼读、例句朗读与麦克风跟读
- “不熟 / 模糊 / 认识”三级复习反馈，按 1、3、7、14、45、120 天逐步安排复习
...
Android 构建会打包官方 Kokoro INT8 美式神经语音、声音数据与英文发音规则。模型压缩包约 103 MB，显著降低了旧版完整模型的手机内存压力。发音规则首次使用时会按官方 Android 方式复制到应用私有目录；神经推理在独立语音进程中运行，即使设备无法加载模型，学习主界面也会保留并自动改用系统朗读。设置中可选择“自动保障”“在线高质量（授权服务）”“离线神经美式”或“系统兼容朗读”。
